package com.uni.common.utils.file;
...
import com.uni.common.config.MinioConfig;
import com.uni.common.config.UniConfig;
import com.uni.common.constant.Constants;
import com.uni.common.exception.file.FileNameLengthLimitExceededException;
import com.uni.common.exception.file.FileSizeLimitExceededException;
import com.uni.common.exception.file.InvalidExtensionException;
import com.uni.common.utils.DateUtils;
import com.uni.common.utils.StringUtils;
import com.uni.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 本地默认上传的地址
     */
    private static String defaultBaseDir = UniConfig.getProfile();
    ...
    {
        int dirLastIndex = UniConfig.getProfile().length() + 1;
